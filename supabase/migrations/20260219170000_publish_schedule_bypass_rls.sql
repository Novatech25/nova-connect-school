-- ============================================
-- RPC Function: Publish Schedule with RLS Bypass
-- Description: Bypasses RLS to update schedule status using SECURITY DEFINER
-- ============================================
...
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER  -- Execute with privileges of the function owner (bypasses RLS)
...
BEGIN
  ...
  -- Audit log (uses audit_action_enum: INSERT/UPDATE/DELETE/LOGIN/LOGOUT/EXPORT/VALIDATE)
