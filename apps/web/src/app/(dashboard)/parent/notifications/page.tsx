...
export default function ParentNotificationsPage() {
    ...
    const getNotificationIcon = (type: string) => {
        const icons: Record<string, any> = {
            ...
            absence_detected: { icon: AlertTriangle, color: 'text-red-600 bg-red-100' },
            ...
            payment_confirmed: { icon: CheckCircle, color: 'text-green-600 bg-green-100' },
            announcement: { icon: Info, color: 'text-indigo-600 bg-indigo-100' },
            child_activity: { icon: Users, color: 'text-cyan-600 bg-cyan-100' },
        };
    ...
    const handleNotificationClick = (notification: any) => {
        ...
        const typeRoutes: Record<string, string> = {
            grade_published: '/parent/grades',
            grade_posted: '/parent/grades',
            attendance_marked: '/parent/attendance',
            absence_detected: '/parent/attendance',
            payment_due: '/parent/payments',
            payment_overdue: '/parent/payments',
            payment_confirmed: '/parent/payments',
            child_activity: '/parent/children',
        };
