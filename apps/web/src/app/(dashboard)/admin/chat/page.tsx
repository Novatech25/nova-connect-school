  ...
  return (
    <div className="max-w-7xl mx-auto py-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500">Communiquez en direct avec le personnel, les étudiants et les parents.</p>
      </div>
      <ChatInterface userId={user.id} role="admin" schoolId={schoolId} />
    </div>
  );
}
