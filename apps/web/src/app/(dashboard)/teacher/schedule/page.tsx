...
export default function TeacherSchedulePage() {
    ...
    // Get unique subjects and classes for filtering
    ...
    const classes = scheduleEntries.reduce((acc: any[], entry: any) => {
        if (entry.class && !acc.find((c: any) => c.id === entry.class.id)) {
