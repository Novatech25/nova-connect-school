...
export default function StudentNotificationsPage() {
  ...
  const getNotificationIcon = (type: string) => {
    const icons: Record<string, any> = {
      ...
      report_card_published: { icon: FileText, color: 'text-green-600 bg-green-100' },
      ...
      assignment_deadline_soon: { icon: AlertTriangle, color: 'text-red-600 bg-red-100' },
      assignment_graded: { icon: CheckCircle, color: 'text-green-600 bg-green-100' },
      attendance_marked: { icon: CheckCircle, color: 'text-teal-600 bg-teal-100' },
      payment_due: { icon: CreditCard, color: 'text-yellow-600 bg-yellow-100' },
      payment_overdue: { icon: AlertTriangle, color: 'text-red-600 bg-red-100' },
      ...
      document_blocked: { icon: XCircle, color: 'text-red-600 bg-red-100' },
      resource_published: { icon: BookOpen, color: 'text-cyan-600 bg-cyan-100' },
    };
  ...
  const getTypeLabel = (type: string) => {
    const labels: Record<string, string> = {
      ...
      assignment_deadline_soon: 'Date limite proche',
      ...
      document_blocked: 'Document bloqué',
  ...
  const handleNotificationClick = (notification: any) => {
    ...
    const typeRoutes: Record<string, string> = {
      grade_published: '/student/grades',
      grade_posted: '/student/grades',
      report_card_published: '/student/report-cards',
      schedule_published: '/student/schedule',
      schedule_updated: '/student/schedule',
      assignment_published: '/student/homework',
      assignment_deadline_soon: '/student/homework',
      assignment_graded: '/student/homework',
      attendance_marked: '/student/attendance',
      payment_due: '/student/payments',
      payment_overdue: '/student/payments',
    };
