  ...
  return (
    <div className="max-w-7xl mx-auto py-6">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500">Posez vos questions à l'administration ou à vos professeurs.</p>
      </div>
      <ChatInterface userId={user.id} role="student" schoolId={schoolId} />
    </div>
  );
}
